...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Diagnostics_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 36, 0)
    ...
    "Diagnostics\0on_pushButton_1_clicked\0"
    "\0"
};
...
const QMetaObject Diagnostics::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Diagnostics.data,
      qt_meta_data_Diagnostics,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Diagnostics.stringdata))
